...
def main(match_format, session_state):
    ...
    with st.beta_expander("Click to see an overview of this tool"):
        st.write("""
        ...
        - Next we have 3 pages "Fantasy - Player Comparisons", "Batting Stats", "Bowling Stats" that you can navigate across through the sidebar. 
